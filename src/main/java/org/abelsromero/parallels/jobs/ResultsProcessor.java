...
final class ResultsProcessor {
    ...
    static ExecutionDetails processExecutionResults(List<Future<JobSummary>> results, int executions, long totalTime) throws ExecutionException, InterruptedException {
        ...
        return ExecutionDetails.builder()
            .time(totalTime)
            .tasksPerSecond(totalTime > 0 ? (executions / (double) (totalTime / 1000)) : 0)

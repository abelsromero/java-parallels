...
abstract class TasksRunnerTest {
    ...
    void should_run_a_single_job() {
        ...
        final JobDetails details = runner.run(() -> {
            Thread.sleep(10);
            return TRUE;
        });
        // then
    ...
    @Test
    void should_run_1000_successful_tasks() {
        // given
    ...
    @Test
    void should_run_1000_successful_and_300_failed_tasks() {
        // given
        final int tasks = 1000;
        final int threads = 8;
        // when
        final TasksRunner runner = runner(tasks + 300, threads);
        final JobDetails details = runner.run(new Callable<>() {
